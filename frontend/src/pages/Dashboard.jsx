...
export default function Dashboard() {
  ...
  const handlePayBill = async (card, amount, paymentMode, accountId) => {
    setPayingCardId(card._id);
    try {
      await payCardBill(card._id, paymentMode, accountId, amount);
    ...
    <Layout>
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 bg-gradient-to-r from-ocean to-blueberry text-white text-xs sm:text-sm font-semibold rounded-xl shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200"
            >
                      ...
                      <div className="flex items-start justify-between mb-2.5">
                        ...
                        <div className="flex items-center gap-2">
                          {card.outstanding > 0 && (
                            ...
                            >
                              {payingCardId === card._id ? 'Paying…' : 'Pay Bill'}
                            </button>
                          )}
      ...
      {payModalCard && (
        <PayBillModal
          ...
          onConfirm={(amount, paymentMode, accountId) => handlePayBill(payModalCard, amount, paymentMode, accountId)}
